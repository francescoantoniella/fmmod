...
class iq(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.blocks_selector_0 = blocks.selector(gr.sizeof_gr_complex*1,0,mute)
        self.blocks_selector_0.set_enabled(True)
        self.blocks_null_sink_0 = blocks.null_sink(gr.sizeof_gr_complex*1)
        self.blocks_interleaved_short_to_complex_0 = blocks.interleaved_short_to_complex(False, False,2**15-1)
        self.blocks_file_source_0 = blocks.file_source(gr.sizeof_short*1, '/dev/stdin', True, 0, 0)
        self.blocks_file_source_0.set_begin_tag(pmt.PMT_NIL)
        self.analog_quadrature_demod_cf_0 = analog.quadrature_demod_cf((912000 / (2*math.pi*75000)))
        ...
        self.connect((self.blocks_interleaved_short_to_complex_0, 0), (self.blocks_selector_0, 0))
    ...
    def set_mute(self, mute):
        self.mute = mute
        self.blocks_selector_0.set_output_index(self.mute)
