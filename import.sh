...
declare -A FILE_MAP=(
  ["audio_pipeline.cpp"]="src/audio_pipeline.cpp"
  ["audio_pipeline.hpp"]="src/audio_pipeline.hpp"
  ["audio_input.cpp"]="src/audio_input.cpp"
  ["audio_input.hpp"]="src/audio_input.hpp"
  ["control_udp.cpp"]="src/control_udp.cpp"
  ["control_udp.hpp"]="src/control_udp.hpp"
  ["globals.hpp"]="src/globals.hpp"
  ["mpx_modulator.hpp"]="src/mpx_modulator.hpp"
  ["upsampler.hpp"]="src/upsampler.hpp"
  ["fm_modulator.hpp"]="src/fm_modulator.hpp"
  ["compressor.hpp"]="src/compressor.hpp"
  ["rds_manager.hpp"]="src/rds_manager.hpp"
  ["iio_compat.hpp"]="src/iio_compat.hpp"
  ["config.hpp"]="src/config.hpp"
  ["constants.hpp"]="src/constants.hpp"
  ["main.cpp"]="src/main.cpp"
  ["pluto_output.cpp"]="src/pluto_output.cpp"
  ["pluto_output.hpp"]="src/pluto_output.hpp"
  ...
  ["peak_tagger.py"]="flowgraphs/peak_tagger.py"
  ["rds_rx_peaks.py"]="flowgraphs/rds_rx_peaks.py"
  ["rds_rx.py"]="flowgraphs/rds_rx.py"
